...
import ieee_11073.part_20601.phd.channel.tcp.TCPChannel;
...
public class BluetoothHDPService extends Service {
    ...
    static BloodPressureAgent bloodPressureAgent;
...
//	    				InternalEventReporter.setDefaultEventManager(iEventManager);
						...
						AndroidMeasureDecoder.setMeasureListener(new MeasureListener(){
							...
							public void getBloodMeasure(MeasureEvent event) {
								...
								Message msg1 = BloodpressureActivity.bpHandler.obtainMessage();
	    						msg1.what = 1;
	    						msg1.obj = ((AndroidBloodMeasure) event.getMeasures()).getHPressure();
	    						BloodpressureActivity.bpHandler.sendMessage(msg1);
	    						Message msg2 = BloodpressureActivity.bpHandler.obtainMessage();
	    						msg2.what = 2;
	    						msg2.obj = ((AndroidBloodMeasure) event.getMeasures()).getLPressure();
	    						BloodpressureActivity.bpHandler.sendMessage(msg2);
...
//	    						new Thread(upload).start();
							...
							public void getPulseMeasure(MeasureEvent event) {
								// TODO Auto-generated method stub
								Message msg3 = BloodpressureActivity.bpHandler.obtainMessage();
	    						msg3.what = 3;
	    						msg3.obj = ((PulseMeasure) event.getMeasures()).getPulse();
	    						BloodpressureActivity.bpHandler.sendMessage(msg3);
							}										
						});
	    				...
	    				//ConfigStorageFactory.setDefaultConfigStorage(new AndroidConfigStorage(BluetoothHDPService.this.getApplicationContext()));
*/					} catch (Exception e) {
